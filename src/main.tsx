...
const options = {
    ...
    info: {beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"NRBR-831606d506bdf5cdc0b",applicationID:"601539290",entityGuid: "MXxCUk9XU0VSfEFQUExJQ0FUSU9OfDYwMTUzOTI5MA",sa:1}, // NREUM.info
